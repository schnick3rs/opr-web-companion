  ...
  <v-row align="stretch">
    ...
    >
      <v-card style="height: 100%">
        <span class="wip-band" v-show="armyBook.autogenerated">Autogenerated</span>
        <div class="pa-2">
        ...
        <v-card-actions>
          ...
          <v-btn v-else text small color="primary" v-show="!armyBook.autogenerated" :href="`/api/army-books/${armyBook.uid}/pdf`"><v-icon left>mdi-printer</v-icon>pdf</v-btn>
          <v-spacer></v-spacer>
          <template v-if="armyBook._type === 'faction'">
            <v-menu offset-y>
              <template v-slot:activator="{ on, attrs }">
