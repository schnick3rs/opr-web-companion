  ...
  <div>
    ...
    >
      <v-app-bar
        ...
        dark
        dense
        src="/img/gf-arena/gf-arena-twitter-wide.jpg"
      >
        ...
        <v-toolbar-title v-else>GF: Arena v1.0</v-toolbar-title>
        <v-spacer />
      ...
      <opr-footer>
        Based on <a href="https://onepagerules.com/portfolio/gf-arena/" title="GF: Arena by OnePageRles">GF: Arena</a> v1.0
      </opr-footer>
    </v-app>
  </div>
</template>
...
export default {
  ...
  head() {
    const title = 'GF: Arena List Builder';
    const description = "Small scale hexfeld skirmish.";
    const image = '/img/gf-arena/gf-arena-twitter-wide.jpg';
    return {
      title: 'Explore',
      titleTemplate: '%s | GF Arena',
      meta: [
